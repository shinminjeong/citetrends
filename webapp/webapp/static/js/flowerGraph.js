...
function drawFlower(svg_id, data, idx, w) {
    ...
    bar[idx] = svg[idx].append("g").selectAll("rect")
      ...
      .enter().append("rect")
        ...
        .style("opacity", 1)
        .style("fill", function(d) { if (d.type == "out") return norcolor[0]; else return norcolor[1]; });
    ...
    svg[idx].append("defs").selectAll("marker")
      ...
      .append("path")
        .attr("d", "M0,-5L10,0L0,5")
        .style("fill", function (d) { if (d.type == "out") return selcolor[0]; else return selcolor[1]; });
    ...
    link[idx] = svg[idx].append("g").selectAll("path")
      ...
      .enter().append("path")
        ...
        .style("stroke", function (d) { if (d.type == "out") return norcolor[0]; else return norcolor[1]; })
